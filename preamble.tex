...
\setlength{\columnseprule}{0.1pt}    % default=0pt (no line)
...
% \addtolength{\oddsidemargin}{-0.8in} % -0.5 del incremento anterior
...
\lstset{
    ...
    basicstyle=\ttfamily, keywordstyle=\ttfamily, stringstyle=\ttfamily, commentstyle=\ttfamily,
...
\newcommand\cppfile[2][]{
\lstinputlisting[style=C++,numbers=none]{#2}
}
